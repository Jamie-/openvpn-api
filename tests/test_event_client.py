...
class TestEventClient(unittest.TestCase):
    def test_input_began(self):
        self.assertTrue(ClientEvent.has_begun(">CLIENT:CONNECT,14,23,"))

    def test_input_not_began(self):
        self.assertFalse(ClientEvent.has_begun(">BYTES:14,23"))

    def test_input_not_began_invalid_type(self):
        self.assertFalse(ClientEvent.has_begun(">CLIENT:INVALID-TYPE,14,23,"))

    def test_input_not_began_empty_input(self):
        self.assertFalse(ClientEvent.has_begun(""))

    def test_input_ended_normal(self):
        self.assertTrue(ClientEvent.has_ended(">CLIENT:ENV,END"))

    def test_input_ended_one_liner(self):
        self.assertTrue(ClientEvent.has_ended(">CLIENT:ADDRESS,14,3,1.1.1.1"))
